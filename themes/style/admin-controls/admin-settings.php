	...
	if(!isset($_GET['action'])){?>
			...
			<table>
				<tr>
					...
					<td><input class="tick_textarea" name="companyTitle" type="text" 
                    	value="<?php echo $comp_authCheck_obj[0]->post_title; ?>" required="required" /></td>
				</tr>
				<tr>
					<th class="tick_gen_cols"><?php _e('Company Site Identification','mhelpdesk');?></th>
					<td class="tick_gen_cols"><?php echo $comp_authCheck_obj[0]->post_name; ?></td>
				</tr>
				<tr>
					<th class="tick_gen_cols"><?php _e('Company Introduction','mhelpdesk');?></th>
					<td>
                    <?php
                    $contnt = $comp_authCheck_obj[0]->post_content;
     ...
     <tr>
		...
		<textarea name="notificationEmails" class="tick_textarea"
        	placeholder="e.g. <?php echo $curUserEmail[0]->user_email;?>, example1@example.com, example2@example.com"><?php echo $notificationEmails;?></textarea>
        </td>
     </tr>
