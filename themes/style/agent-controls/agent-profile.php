...
<form name="formProfileUpdation" action="#" method="post">
	<table>
		<tr>
			...
			<td>
				<input type="text" class="tick_textarea" name="fullname" value="<?php echo $curUserInfoObj[0]->display_name; ?>" required />
			</td>
		</tr>
		<tr>
			<th class="tick_gen_cols"><?php _e('Username','mhelpdesk');?></th>
			<td class="tick_gen_cols"><?php echo $curUserInfoObj[0]->user_login; ?></td>
		</tr>
        <tr>
		...
		<tr>
			...
			<td><?php echo $curUserInfoObj[0]->user_email; ?></td>
		</tr>
        <tr><td colspan="2">
