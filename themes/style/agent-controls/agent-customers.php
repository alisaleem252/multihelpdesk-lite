			...
			<table>
                ...
                <tr>
                	<td>
                        ...
                        <br /><br />
                                <p>
                                 <a href="?action=customer_tickets&id=<?php echo $customerID; ?>">View Tickets</a>
                                 <a href="?action=edit&id=<?php echo $customerID; ?>">Edit</a> 
                                </p>
                    </td>
...
//print_r($compCustomerBlocked_DB_arr);  
	...
	if(!isset($compCustomerBlocked_DB_arr[$customer_id_GET])){
		...
		<table>
        	<tr><td colspan="3" class="tick_gen_cols"><h2><?php echo $customer_displaynameObj[0]->display_name; ?></h2></td></tr>
            <tr>
...
<?php  } // if(isset($customerTickets_DB_objs[0]))
		...
		else echo '<h1 ><br /><br />This Customer ('.$customer_displaynameObj[0]->display_name.') is BLOCKED.</h1>';
...
<a href="<?php echo $_SERVER['HTTP_REFERER'];?>" >Go Back to Customer's Home Link</a>
        <table>
            ...
            <tr>
                <td><?php echo $customer_displaynameObj[0]->display_name; ?></td>
                <td>
